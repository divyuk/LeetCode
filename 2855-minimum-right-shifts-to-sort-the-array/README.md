...
<pre style="position: relative;"><strong>Input:</strong> nums = [1,3,5]
<strong>Output:</strong> 0
<strong>Explanation:</strong> nums is already sorted therefore, the answer is 0.<div class="open_grepper_editor" title="Edit &amp; Save To Grepper"></div></pre>
