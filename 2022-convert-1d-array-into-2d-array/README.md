...
<pre style="position: relative;"><strong>Input:</strong> original = [1,2,3,4], m = 2, n = 2
...
<pre style="position: relative;"><strong>Input:</strong> original = [1,2,3], m = 1, n = 3
...
<pre style="position: relative;"><strong>Input:</strong> original = [1,2], m = 1, n = 1
