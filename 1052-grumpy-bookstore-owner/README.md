...
<pre style="position: relative;"><strong>Input:</strong> customers = [1,0,1,2,1,1,7,5], grumpy = [0,1,0,1,0,1,0,1], minutes = 3
...
<pre style="position: relative;"><strong>Input:</strong> customers = [1], grumpy = [0], minutes = 1
