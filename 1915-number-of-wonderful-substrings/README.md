...
<pre style="position: relative;"><strong>Input:</strong> word = "aba"
...
<pre style="position: relative;"><strong>Input:</strong> word = "aabb"
...
<pre style="position: relative;"><strong>Input:</strong> word = "he"
