...
public:
    int oddEvenJumps(vector<int>& A) {
        ...
        int n = A.size();
        vector<int> next_higher(n), next_lower(n); // odd jump and even jump
        ...
        // for(int i = 0; i< n ; i++) cout<<sortedA[i].first <<" "<< sortedA[i].second<<"\n";
        ...
        //     }
        //     cout << endl;
         for(int i = 0; i< n ; i++) cout<<next_higher[i] <<" ";
