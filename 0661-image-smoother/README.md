...
<pre style="position: relative;"><strong>Input:</strong> img = [[1,1,1],[1,0,1],[1,1,1]]
...
<pre style="position: relative;"><strong>Input:</strong> img = [[100,200,100],[200,50,200],[100,200,100]]
