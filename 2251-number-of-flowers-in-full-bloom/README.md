...
<pre style="position: relative;"><strong>Input:</strong> flowers = [[1,6],[3,7],[9,12],[4,13]], people = [2,3,7,11]
...
<pre style="position: relative;"><strong>Input:</strong> flowers = [[1,10],[3,3]], people = [3,3,2]
