...
<pre style="position: relative;"><strong>Input:</strong> sticks = [2,4,3]
...
<pre style="position: relative;"><strong>Input:</strong> sticks = [1,8,3,5]
...
<pre style="position: relative;"><strong>Input:</strong> sticks = [5]
