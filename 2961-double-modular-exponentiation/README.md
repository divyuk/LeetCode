<h2><a href="https://leetcode.com/problems/double-modular-exponentiation/">2961. Double Modular Exponentiation</a></h2><h3>Medium</h3><hr><div><p>You are given a <strong>0-indexed</strong> 2D array <code>variables</code> where <code>variables[i] = [a<sub>i</sub>, b<sub>i</sub>, c<sub>i,</sub> m<sub>i</sub>]</code>, and an integer <code>target</code>.</p>
...
<pre style="position: relative;"><strong>Input:</strong> variables = [[2,3,3,10],[3,3,3,1],[6,1,1,4]], target = 2
...
<pre style="position: relative;"><strong>Input:</strong> variables = [[39,3,1000,1000]], target = 17
